...
business_data AS (
    SELECT 
        ...
        (j->'attributes'->'Ambience'->>'romantic') AS IsRomantic,
        (j->'attributes'->'Ambience'->>'intimate') AS IsIntimate,
        (j->'attributes'->'Ambience'->>'touristy') AS IsTouristy,
        (j->'attributes'->'Ambience'->>'hipster') AS IsHipster,
        (j->'attributes'->'Ambience'->>'divey') AS IsDivey,
        (j->'attributes'->'Ambience'->>'classy') AS IsClassy,
        (j->'attributes'->'Ambience'->>'trendy') AS IsTrendy,
        (j->'attributes'->'Ambience'->>'upscale') AS IsUpscale,
        (j->'attributes'->'Ambience'->>'casual') AS IsCasual,
        -- Extract and rename BusinessParking attributes
        (j->'attributes'->'BusinessParking'->>'garage') AS parking_garage,
        (j->'attributes'->'BusinessParking'->>'street') AS parking_street,
        (j->'attributes'->'BusinessParking'->>'validated') AS parking_validated,
        (j->'attributes'->'BusinessParking'->>'lot') AS parking_lot,
        (j->'attributes'->'BusinessParking'->>'valet') AS parking_valet
